...
TEST(API, TestMatcher)
{
	...
	ASSERT_EQ(1, chromaprint_matcher_set_fingerprint(ctx, 0, fp_roar1, strlen(fp_roar1), 1));
	ASSERT_EQ(1, chromaprint_matcher_set_fingerprint(ctx, 1, fp_roar2, strlen(fp_roar2), 1));
