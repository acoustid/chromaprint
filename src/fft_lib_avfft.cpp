...
void FFTLib::ComputeFrame(CombinedBuffer<short>::Iterator input, int length, double *output)
{
	memset(m_input, 0, sizeof(float) * m_frame_size);
	ApplyWindow(input, m_window, m_input, length, 1.0);
